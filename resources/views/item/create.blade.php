        ...
        <div class="col-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="forms-sample" method="POST" action="{{ url('item') }}">
                        @csrf

                        <div class="form-group">
                            <label for="exampleInputUsername1">Kode Barang</label>
                            <input type="text" class="form-control @error('kode_barang') is-invalid @enderror"
                                name="kode_barang" id="exampleInputUsername1" value="{{ @old('kode_barang') }}"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('nama_barang') is-invalid @enderror"
                                value="{{ @old('nama_barang') }}" name="nama_barang" id="exampleInputUsername1"
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control @error('harga_beli') is-invalid @enderror"
                                name="harga_beli" id="exampleInputUsername1" value="{{ @old('harga_beli') }}"
                                placeholder="harga_beli" min="0">
                            @error('harga_beli')
                                <div class="invalid-feedback text-red">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('satuan') is-invalid @enderror" name="satuan"
                                id="exampleInputUsername1" placeholder="satuan" value="{{ @old('satuan') }}">
                            @error('satuan')
                                <div class="invalid-feedback text-red">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control " name="nama_category" id="category">
                                ...
                                @foreach ($categories as $item)
                                    <option value="{{ $item->nama }}" @selected(@old('nama_category') === $item->nama)>{{ $item->nama }}
                                    </option>
                                @endforeach
                            </select>
